...
public class WordCounter {
	...
	private static int MAX_FREQ=10000;
	...
	private List<Set<String>> topicList;
	...
	private void InitWordCount()
	{
		...
		for(int i=0;i<docTotalNumber;i++)
		{
			...
			Set<String> topic=new HashSet<>(reuterList.get(i).topics);
			topicList.add(topic);
		}
	}
	public List<Set<String>> getActualTopic()
	{
		return topicList;
	}
