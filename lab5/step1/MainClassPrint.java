...
public class MainClassPrint {
	...
	private static void printToFile(List<Map<String,Double>> tfidfList,List<Set<String>> topicList,int split) throws IOException
	{
		...
		FileWriter transactionWriter=new FileWriter("../result/transcation");
		FileWriter classWriter=new FileWriter("../result/class");
		...
		classWriter.close();
		FileWriter testDataWriter=new FileWriter("../result/testData");
		FileWriter actualWriter=new FileWriter("../result/actual");
